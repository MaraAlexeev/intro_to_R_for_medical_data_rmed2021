...
Usually we want to get counts from a categorical variable,
so when there are 100s of unique values, that is typically a column that we wouldn't be counting.
