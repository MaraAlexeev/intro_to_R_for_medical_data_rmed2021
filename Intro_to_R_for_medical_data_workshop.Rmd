...
- the default theme is a bit plain


Let's make our plot a bit prettier. 

- Give your plot a nice title. 
- Create better labels for the x and y axes
...
Let's modify the width of our histogram's bins in the code chunk below to 2. 
...
Image from [Thomas Lin Pedersen](https://ds4biomed.tech/visualization-intro.html#grammar-of-graphics/)
